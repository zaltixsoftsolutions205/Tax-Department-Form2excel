        ...
        <div style={{ backgroundColor: '#3264C8' }} className="text-white">
          ...
          <div className="flex items-center gap-2 md:gap-4 px-3 md:px-5 pb-3">
            ...
            <div className="flex-1 text-center" style={{ minWidth: 0 }}>
              <h1 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 'clamp(0.9rem, 4.5vw, 2.2rem)', fontWeight: 700, lineHeight: 1.1, letterSpacing: '0.1em', wordSpacing: '0.2em', textTransform: 'uppercase', color: '#CC0000', textShadow: '-1px 0 0 #fff, 1px 0 0 #fff, 0 -1px 0 #fff, 0 1px 0 #fff' }}>
                Telangana Commercial Taxes
              </h1>
              <h2 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 'clamp(0.82rem, 4vw, 2rem)', fontWeight: 700, lineHeight: 1.1, letterSpacing: '0.1em', wordSpacing: '0.2em', textTransform: 'uppercase', color: '#CC0000', textShadow: '-1px 0 0 #fff, 1px 0 0 #fff, 0 -1px 0 #fff, 0 1px 0 #fff' }}>
